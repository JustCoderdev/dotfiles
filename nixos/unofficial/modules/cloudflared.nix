# Fixed Cloudflared module
# src <https://raw.githubusercontent.com/NixOS/nixpkgs/1750f3c1c89488e2ffdd47cab9d05454dddfb734/nixos/modules/services/networking/cloudflared.nix>
...
let
  cfg = config.unofficial.services.cloudflared;
