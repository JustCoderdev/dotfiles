...
badd +96 lua/perin/plugins.lua
badd +1 lua/perin
badd +20 lua/perin/plugin_config/init.lua
...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((24 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
if bufexists(fnamemodify("~/.config/nvim/lua/perin/plugins.lua", ":p")) | buffer ~/.config/nvim/lua/perin/plugins.lua | else | edit ~/.config/nvim/lua/perin/plugins.lua | endif
if &buftype ==# 'terminal'
  silent file ~/.config/nvim/lua/perin/plugins.lua
endif
...
silent! normal! zE
let &fdl = &fdl
let s:l = 96 - ((23 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 96
