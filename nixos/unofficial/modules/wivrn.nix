# Taken from <https://github.com/NixOS/nixpkgs/blob/c27cdad491a991b11ed731760aa2ef8db0cb0410/nixos/modules/services/video/wivrn.nix>
{
  config,
  pkgs,
  lib,
...
let
  inherit (lib)
    ...
    makeBinPath
    ;
  cfg = config.unofficial.services.wivrn;
