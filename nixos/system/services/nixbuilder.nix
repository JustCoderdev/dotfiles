			...
			lib.mkIf server_cfg.enable
			{
				...
				users.users."${buildclient_user}" =
				{
					...
					openssh.authorizedKeys.keys = [
						...
						"ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHXUWUHRftp040wwK7gnrDkzvUPYWsktkGcb4+kVaCTJ ryuji_buildclient@jarvis"
						...
						"ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBE1GIRd5lcOktNue8wZmHtXzPAINRTFydaARWBkdroN ryuji_buildclient@niximg"
					];
				};
			}
		)
